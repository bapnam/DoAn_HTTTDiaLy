...
namespace MapTGDD.Models
{
    ...
    public partial class Model_MapTGDDEntities : DbContext
    {
        public Model_MapTGDDEntities()
            : base("name=Model_MapTGDDEntities")
        {
        }
        ...
        public DbSet<DiaChi_TGDD> DiaChi_TGDD { get; set; }
